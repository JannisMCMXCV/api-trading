...
import de.mcmxcv.apitrading.exchange.order.LongMarketOrder;
import de.mcmxcv.apitrading.exchange.position.Position;

public class LongLimitStopOrder extends LongMarketOrder {	
	
	public LongLimitStopOrder(Exchange exchange, String instrumentId, Price pendingEntryPrice) {
