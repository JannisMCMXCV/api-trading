...
public class LongPosition extends AbstractPosition {
	
	protected LongPosition(Instrument instrument, Exchange exchange) {
		super(instrument, exchange);
		// TODO Auto-generated constructor stub
	}
	
	protected LongPosition(Instrument instrument, Exchange exchange, RiskControl stopLoss, RiskControl takeProfit) {
